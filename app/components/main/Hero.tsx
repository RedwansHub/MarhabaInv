...
const Hero = (props: Props) => {
  ...
  return (
    <div className='h-screen landing w-full cursor-default lg:px-24 md:px-12 px-8'>
      <div className='w-full h-full flex items-center justify-center text-white  pt-24 md:pt-16 lg:p-16 sm:p-8'>
        <div className='flex flex-col lg:p-4 gap-12 lg:w-[60%] md:w-[80%] w-full'>
          ...
          <AnimateZoomIn delay={1.5}>
            <div className='border-2 rounded-full px-16 hover:bg-green-500/50 hover:border-transparent hover:scale-105  cursor-pointer duration-300 ease-in py-3 text-center'>
              Explore
            </div>
          </AnimateZoomIn>
